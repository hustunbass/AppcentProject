...
class OppurtunityViewController: UIViewController,isAbleToReceiveData {
    ...
    func configureView(){
        ...
        bgImage.image = UIImage(named: "ivana-cajina-asuyh-_ZX54-unsplash");
...
extension OppurtunityViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout  {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "oppurtunityCell", for: indexPath) as? OppurtunityViewCell {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "showPopUpOppurtunity", sender: nil)
